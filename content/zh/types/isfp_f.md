...
外向思维（Extraverted Thinking, Te）是ISFP女性的“阿喀琉斯之踵” 12，是她最不擅长、最感不适的功能。Te处理的是逻辑、效率、组织和客观的外部系统 12。她倾向于只在绝对必要时才动用它 12。
